...
async def get_thumb(videoid):
    try:
        ...
        if 1==1:
            ...
            circle = Image.open("VenomX/assets/circle.png")
            ...
            image4.text((10, 10), "NOXIxMUSIC", fill="white", font = font1, align ="middle") 
            image4.text((670, 150), "NOXIXMUSIC", fill="white", font = font2, stroke_width=2, stroke_fill="white", align ="left") 
